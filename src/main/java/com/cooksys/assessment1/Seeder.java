...
import lombok.RequiredArgsConstructor;
	...
	public void run(String... args) throws Exception {
		...
		tweet1.setHashtags(List.copyOf(Arrays.asList(hashtag1, hashtag2)));
		...
		tweet2.setHashtags(List.copyOf(Arrays.asList(hashtag1, hashtag2)));
		...
		tweet3.setHashtags(List.copyOf(Arrays.asList(hashtag3, hashtag4)));
		...
		user1.setLikedTweets(List.copyOf(user3Tweets));
		userRepository.saveAndFlush(user1);
		user2.setLikedTweets(List.copyOf(user1Tweets));
		userRepository.saveAndFlush(user2);
		user3.setLikedTweets(List.copyOf(user2Tweets));
		userRepository.saveAndFlush(user3);
		...
		user1.setFollowing(List.copyOf(following_1));
		List<User> followers_1 = List.of(user5, deletedUser);
		user1.setFollowers(List.copyOf(followers_1));
		userRepository.saveAndFlush(user1);
	}
}
